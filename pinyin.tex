...
\node[draw, inner sep=5pt, rounded corners=3pt] {
\begin{tabular}{c@{\hspace{3em}}c@{\hspace{3em}}c@{\hspace{3em}}c@{\hspace{3em}}c@{\hspace{3em}}c}
  \pinyin{ga} & \strike{\pinyin{go}} & \pinyin{ge} & \pinyin{gi} & \pinyin{gu} & \strike{\pinyin{gü}} \\
  \pinyin{ka} & \strike{\pinyin{ko}} & \pinyin{ke} & \pinyin{ki} & \pinyin{ku} & \strike{\pinyin{kü}} \\
  \pinyin{ha} & \strike{\pinyin{ho}} & \pinyin{he} & \pinyin{hi} & \pinyin{hu} & \strike{\pinyin{hü}} \\
\end{tabular}
};
\end{tikzpicture}
